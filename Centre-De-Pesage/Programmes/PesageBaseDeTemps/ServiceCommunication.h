 ...
 */
#define SCOMMS_PARSE_RX_BUFFER_ADR 2
/**
 * @brief The address from the timebase buffer (index) which will be used to put
 * \ref ServiceCommunication_TXParsingHandler() in
 */
#define SCOMMS_PARSE_TX_BUFFER_ADR 3
/**
 ...
 */
#define CAN_ALLOCATED_SLOT 2 // Pour centre de pesage
/**
 ...
 * address
 */
#define MODULE_CAN_RX_BUFFER piloteCAN.readBuffer
/**
 * @brief Specify how to access the unsigned char array of 8 bytes which
 ...
 * address
 */
#define MASTER_CAN_RX_BUFFER piloteCAN.readBuffer
/**
 * @brief Specify how to access the unsigned char array of 8 bytes which
 ...
 */
#define MODULE_CAN_TX piloteCAN.replyBuffer
/**
 ...
 */
#define CHECK_MODULE_CAN_RECEPTION 0xFF  // Doit etre a True
/**
 * @brief Statement which is true only if a CAN message addressed to your
 * module is available.
 * It is false if no messages have been received.
