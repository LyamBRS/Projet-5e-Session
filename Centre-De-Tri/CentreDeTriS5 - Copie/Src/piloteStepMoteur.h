...
#define PILOTESTEPMOTEUR_STEP0 0
#define PILOTESTEPMOTEUR_STEP1 1
#define PILOTESTEPMOTEUR_STEP2 2
#define PILOTESTEPMOTEUR_STEP3 3

#define PILOTESTEPMOTEUR_ACTIVE 1
#define PILOTESTEPMOTEUR_DESACTIVE 0
