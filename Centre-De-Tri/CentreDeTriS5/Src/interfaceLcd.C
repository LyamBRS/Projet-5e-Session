...
// loop form 0 to the distance inbetween the 2 points
   for(unsigned char i = 0; i<=ceil(lenght); i++)
      {
        interfaceLcd_Draw_Pixel((x1 + (i*ratioX)), (y1 + (i*ratioY)),   state);
      }
}
...
//��������������������������������������������������������������������������������������������������
{
 ...
 //Top line
 interfaceLcd_Draw_Line(x, y, x+width, y, state); 
  
 //Bottom line
 interfaceLcd_Draw_Line(x, y+height, x+width, y+height, state);  
  
 //Right line
 interfaceLcd_Draw_Line(x+width, y, x+width, y+height, state); 
 
 //Left line
 interfaceLcd_Draw_Line(x, y, x, y+height, state);   
}
//��������������������������������������������������������������������������������������������������
  ...
  for(int i=x; i<(x+width); i++)
     {
      for(int e=y; e<(y+height); e++)  
         {
          interfaceLcd_Draw_Pixel(i,e,state);
         }
     }
  }
  else
...
//��������������������������������������������������������������������������������������������������
{  
   interfaceLcd_Draw_Pixel(ceil((sin(radian)*radius)+x),ceil((cos(radian)*radius)+y),state);
}
...
{  
  // draws the pixel deformed by 2 different radius value.
     interfaceLcd_Draw_Pixel(ceil((sin(radian)*(radiusX))+x),ceil((cos(radian)*(radiusY))+y),state);
}
...
{  
  // draws the line of pixel starting from the center radius, to the outer radius
     interfaceLcd_Draw_Line(ceil((sin(radian)*InsideRadius)+x),ceil((cos(radian)*InsideRadius)+y),ceil((sin(radian)*OutsideRadius)+x),ceil((cos(radian)*OutsideRadius)+y),state);
}
...
//��������������������������������������������������������������������������������������������������
{
  ...
  for(double i = 0; i <= 6.28; i += increment)
     {
        interfaceLcd_Draw_Pixel(floor(sin(i)*radius)+x, floor(cos(i)*radius)+y, state);
     }
}
      ...
      for(unsigned char checkY = leftTopY; checkY <= heigthCoord; checkY++)
         {
           if(RadiusSquared < (((checkX - x)*(checkX - x)) + ((checkY - y)*(checkY - y))))
             {
               //interfaceLcd_Draw_Pixel(checkX, checkY, !state);
             }
           else
             {
               interfaceLcd_Draw_Pixel(checkX, checkY, state);             
...
//��������������������������������������������������������������������������������������������������
{
    interfaceLcd_Draw_Shape_RectF(x,         y,             6*scale,scale,state);
    interfaceLcd_Draw_Shape_RectF(x+5*scale, y+scale,       scale,  scale,state);    
    interfaceLcd_Draw_Shape_RectF(x+4 *scale,y+2*scale,     scale,  scale,state);
    interfaceLcd_Draw_Shape_RectF(x+5 *scale,y+3*scale,     scale,  scale,state);
    interfaceLcd_Draw_Shape_RectF(x,         y+2*scale,     2*scale, scale,state);
    interfaceLcd_Draw_Shape_RectF(x,         y+4*scale,     6*scale, scale,state); 
    interfaceLcd_Draw_Shape_RectF(x+7 *scale,y,             6*scale, scale,state);
    interfaceLcd_Draw_Shape_RectF(x+12*scale,y+scale,       scale,  scale,state);    
    interfaceLcd_Draw_Shape_RectF(x+11*scale,y+2*scale,     scale,  scale,state);
    interfaceLcd_Draw_Shape_RectF(x+12*scale,y+3*scale,     scale,  2*scale,state);
    interfaceLcd_Draw_Shape_RectF(x+7 *scale,y+2*scale,     2*scale, scale,state);  
    interfaceLcd_Draw_Shape_RectF(x+7 *scale,y+4*scale,     2*scale, scale,state);
    interfaceLcd_Draw_Shape_RectF(x+15*scale,y,             5*scale, scale,state);
    interfaceLcd_Draw_Shape_RectF(x+14*scale,y+scale,       scale,  scale,state);     
    interfaceLcd_Draw_Shape_RectF(x+14*scale,y+2*scale,     6*scale, scale,state);
    interfaceLcd_Draw_Shape_RectF(x+19*scale,y+3*scale,     scale,  scale,state);
    interfaceLcd_Draw_Shape_RectF(x+14*scale,y+4*scale,     5*scale, scale,state);    
}

//��������������������������������������������������������������������������������������������������
  void interfaceLcd_Draw_Misc_LabHeader(char const *lab, char const *Table)
//__________________________________________________________________________________________________
//  	Creator:	|Shawn Couture
...
//        HAL_Delay(speed);
        switch(direction)
              {
                case(0):
                          interfaceLcd_Draw_Line(i,0,i,64,1);
                          interfaceLcd_Draw_Line(i+1,0,i+1,64,1);                          
                          break;
           
                case(1):
                          interfaceLcd_Draw_Line(0,i,128,i,1);                     
                          interfaceLcd_Draw_Line(0,i+1,128,i+1,1);                  
                          break;
           
                case(2):
                          interfaceLcd_Draw_Line(127-i,0,127-i,64,1);
                          interfaceLcd_Draw_Line(127-(i+1),0,127-(i+1),64,1);                            
                          break;
                case(3):
                          interfaceLcd_Draw_Line(0,63-i,128,63-i,1);
                          interfaceLcd_Draw_Line(0,63-(i+1),128,63-(i+1),1);                             
                          break;           
                }
      }
   //Clear lines
...
//        HAL_Delay(speed);
        switch(direction)
              {
                case(0):
                          interfaceLcd_Draw_Line(i,0,i,64,0);
                          interfaceLcd_Draw_Line(i+1,0,i+1,64,0);                          
                          break;
           
                case(1):
                          interfaceLcd_Draw_Line(0,i,128,i,0);                     
                          interfaceLcd_Draw_Line(0,i+1,128,i+1,0);                  
                          break;
           
                case(2):
                          interfaceLcd_Draw_Line(127-i,0,127-i,64,0);
                          interfaceLcd_Draw_Line(127-(i+1),0,127-(i+1),64,0);                            
                          break;
                case(3):
                          interfaceLcd_Draw_Line(0,63-i,128,63-i,0);
                          interfaceLcd_Draw_Line(0,63-(i+1),128,63-(i+1),0);                             
                          break;           
                }
      }
}
...
//��������������������������������������������������������������������������������������������������
{
  ...
  for(unsigned char i=0; i<length; i++)
    {
      interfaceLcd_Draw_Text_Char(x + (i*5),y, string[i],4,state);
    }
}
//��������������������������������������������������������������������������������������������������
...
/////////////////////////////////////////////////////////////////////////////////////[NEW DIGIT MAX]  
    ...
    for(unsigned int currentDigit = 1; currentDigit <= maxDigits; currentDigit++)
       {
         ...
         displaying = Number;
          ...
          if(displaying == 0xFF)
          {
            interfaceLcd_Draw_Text_Char(((maxDigits-1)*5)-((currentDigit-1)*5) + x,y, ' ', 4, state); 
          }
          else
          {
            interfaceLcd_Draw_Text_Char(((maxDigits-1)*5)-((currentDigit-1)*5) + x,y, (unsigned char)displaying+0x30, 4, state);            
          }
        }
   }
  ...
  else //Negative number
  {
    ...
    interfaceLcd_Draw_Text_Char(x,y,'-',4,state);
  }
...
//��������������������������������������������������������������������������������������������������
{
  ...
  {
    //DRAW 0x
    interfaceLcd_Draw_Text_Char(x,y,'0',4,state);    
    interfaceLcd_Draw_Text_Char(x+5,y,'x',4,state);     
    ...
    for(unsigned currentDigit = maxDigits; currentDigit > 0; currentDigit--)
       {
          ...
          interfaceLcd_Draw_Text_Char(posX,y,Table[Value],4,1);
...
//��������������������������������������������������������������������������������������������������
{
  ...
  if(Number>=0)
  {
    interfaceLcd_Draw_Text_Char(x+((maxDigits)*5)+((decimals)*5)+5,y,' ',4,state);
  }  
      ...
      for(unsigned currentDigit = maxDigits; currentDigit > 0; currentDigit--)
       {
         ...
         interfaceLcd_Draw_Text_Char((currentDigit-1)*5 + posX,y,(unsigned char)displaying+0x30,4,state);

       }
  //////////////////////////////////////////////////////////////////////////////////////////////////[DECIMAL]
  //DRAW DECIMAL POINT
  interfaceLcd_Draw_Text_Char(posX + (maxDigits)*5 ,y,'.',4,state);
      ...
      for(unsigned currentDigit = decimals; currentDigit > 0; currentDigit--)
       {
         ...
         interfaceLcd_Draw_Text_Char((decimals-currentDigit)*5 + posX,y,(unsigned char)displaying+0x30,4,state);
...
//	Date made:	| 31/03/2022
//__________________________________________________________________________________________________
//	Function:	| Demonstrate effects that can be acheived using interfaceLcd_Draw_Line.
...
//��������������������������������������������������������������������������������������������������
{
  ...
  interfaceLcd_Draw_Line(0,0,63,63,1); // diagonal from top left to bottom middle
  interfaceLcd_Draw_Line(63,0,0,63,1); // diagonal from middle top to bottom left

  interfaceLcd_Draw_Line(63,0,127,63,1);  // diagonal from middle top to bottom right
  interfaceLcd_Draw_Line(63,63,127,0,1);  // diagonal from bottom middle to top right

  interfaceLcd_Draw_Line(0,0,126,62,1);  // diagonal from top left to bottom right
  interfaceLcd_Draw_Line(126,0,0,62,1);  // diagonal from top right to bottom left
...
//##################################################################################################// CIRCLE PIXEL    
    if(NextFunction == 0)
    {
      ...
      interfaceLcd_Draw_CirclePixel(63,31,oldRadius1,localCount,0); // Erase the pixel at the last radian      
      interfaceLcd_Draw_CirclePixel(63,31,newRadius1,count,1);      //Draw the pixel at the current radian

      //____________________________________________________________________________[RADIUS COUNTER]
      if(count      >= 6.25){ newRadius1++; }      
      if(localCount >= 6.25){ oldRadius1++; interfaceLcd_Draw_Text_Integer(60,30,(unsigned char)newRadius1,2,1);}
      ...
      interfaceLcd_Draw_Text_Double(40,55,count,2,1,1);
      
      //////////////////////////////////////////////////////////////////////////////////////////////[DRAWN ONCE]         
      if(state == 0)
      {
        state = 1;
        interfaceLcd_Draw_Text_String(0,55,"Radians:",4,1);
      ...
      {       
        interfaceLcd_Clear_Swipe(1);
        interfaceLcd_Draw_Misc_ScalableBRS(50,5,1,1);         
...
////////////////////////////////////////////////////////////////////////////////////////////////////[FIRST HALF]      
      if(AnimationCounter > AnimationTime/2)
      {
       ...
       //______________________________________________________________________[Draw radius Numbers]        
        interfaceLcd_Draw_Text_Integer(31,48,(unsigned char)newRadius1,2,1);
        interfaceLcd_Draw_Text_Integer(31,55,(unsigned char)newRadius2,2,1);        
            ...
            if(oldCount == 1)
              {
                ...
                interfaceLcd_Draw_Shape_RectF(62,30,27,27,0);
              }
            
            //Draw a line from a circle with from the first counter radius to the next counter radius
            for(double i = 0; i<1.58; i+=0.01)
               {
                interfaceLcd_Draw_CircleLine(63,31,newRadius1,newRadius2,i,1);                   
               }
        
            //Clear the edges to avoid phantoms
            for(double i = 0; i<1.59; i+=0.01)
              {        
                interfaceLcd_Draw_CirclePixel(63,31,newRadius1-1,i,0);
                interfaceLcd_Draw_CirclePixel(63,31,newRadius2+1,i,0); 
              }
          }
...
////////////////////////////////////////////////////////////////////////////////////////////////////[SECOND HALF]       
      else
      {
        ...
        interfaceLcd_Draw_Text_Double(1,55,count,2,1,1);
        ...
        if(oldCount != 2)
          {
            ...
            //LCD Clear
            interfaceLcd_Draw_Shape_RectF(0,9,127,51,0);
          
            //New text display
            vPutStringGLcd("       Radians      ", 0,5);
          
            //Redraw the quarter of circle
            for(double i = 0; i<1.58; i+=0.01) {interfaceLcd_Draw_CircleLine(63,31,newRadius1,newRadius2,i,1);}          
        ...
        interfaceLcd_Draw_CircleLine(63,31,newRadius1,newRadius2,localCount,1); //draw a line
        interfaceLcd_Draw_CircleLine(63,31,newRadius1,newRadius2,count,0);      //clears behind line
      }
////////////////////////////////////////////////////////////////////////////////////////////////////[DRAWN ONCE]      
      if(state == 0)
        {
          ...
          interfaceLcd_Draw_Text_String(1,48,"Start:",4,1);
          interfaceLcd_Draw_Text_String(1,55,"Edges:",4,1); 
        }
    ...
    if(NextFunction == 2)
    {
     ...
     //__________________________________[CLEAR OLD PIXELS]
       for(double i = 0; i<6.27; i+=0.01)
          {
            interfaceLcd_Draw_OvalPixel(63, 32, newRadius1, newRadius2, i, 0);
          }        
     ...
     //____________________________________________________________________________[DRAW NEW PIXELS]
       for(double i = 0; i<6.27; i+=0.01)
       {
        interfaceLcd_Draw_OvalPixel(63, 32, newRadius1, newRadius2, i, 1);
       }
     ...
     interfaceLcd_Draw_Text_Integer(11,48,(unsigned char)newRadius1,2,1);
     interfaceLcd_Draw_Text_Integer(11,55,(unsigned char)newRadius2,2,1);
        
////////////////////////////////////////////////////////////////////////////////////////////////////[DRAWN ONCE]
     if(state == 0)
       { state = 1;
        
        interfaceLcd_Draw_Text_String(1,48,"X:",4,1);
        interfaceLcd_Draw_Text_String(1,55,"Y:",4,1);         
...
//##################################################################################################// PERFECT CIRCLES  
    if(NextFunction == 3)
    {
      ...
      { localCount = 0;
        ...
        interfaceLcd_Draw_Shape_CircleF(30,30,newRadius1,0);
        interfaceLcd_Draw_Shape_Circle (100,30,newRadius1,0);      
////////////////////////////////////////////////////////////////////////////////////////////////////[COUNTER]
        ...
        interfaceLcd_Draw_Shape_CircleF(30,30,newRadius1,1);
        interfaceLcd_Draw_Shape_Circle (100,30,newRadius1,1);
        
        //_____________________________________________________________________________[DRAW RADIUS]          
        interfaceLcd_Draw_Text_Integer(35,55,(unsigned char)newRadius1,2,1);
      }
        localCount++;
////////////////////////////////////////////////////////////////////////////////////////////////////[DRAWN ONCE]
     if(state == 0)
       { state = 1;
        ...
        interfaceLcd_Draw_Text_String(1,55,"Radius:",4,1);         
...
////////////////////////////////////////////////////////////////////////////////////////////////////[COUNTER]      
       ...
       interfaceLcd_Draw_Text_Double(55,29,count,1,1,1);
...
////////////////////////////////////////////////////////////////////////////////////////////////////[DRAWN ONCE]
     if(state == 0)
       ...
       // TEXT
        interfaceLcd_Draw_Text_String(1,55,"Radians:",4,1);
        vPutStringGLcd("   Radian Values   ", 0,5);
        
       // Middle Circle
        interfaceLcd_Draw_Shape_Circle(63,31,10,1);
...
////////////////////////////////////////////////////////////////////////////////////////////////////[LOADING BAR DRAWING]
    ...
    if(loadingBarCoord > 0 && loadingBarCoord<127)
    {
      ...
      {
        interfaceLcd_Draw_Shape_RectF(loadingBarCoord, 61, 1, 3, 1);
...
//��������������������������������������������������������������������������������������������������
void interfaceLcd_Demo_Text(void)
//__________________________________________________________________________________________________
//  	Creator:	|Shawn Couture
//	Date made:	| 04/04/2022
//__________________________________________________________________________________________________
//	Function:	| 
//                      | Demonstrates the easy use and implementations of interfaceLcd_Text functions
//                      | 
...
//////////////////////////////////////////////////////////////////////////////////////////////[DEMO] 
   ...
   interfaceLcd_Draw_Text_String(0,0,"0123456789!\"#$%'()*+,-./",4,1);
   interfaceLcd_Draw_Text_String(0,7,"ABCDEFGHIJKLMNOPQRSTUVWXYZ",4,1);
   interfaceLcd_Draw_Text_String(0,14,"{}[]`_/^~|�?&���",4,1);
 ...
 while(1)
 {
   ...
   interfaceLcd_Draw_Text_Integer(10,30,countA,3,1);  
 }
}
...
{
  vClearGLcd(0xFF);
  interfaceLcd_Draw_Misc_ScalableBRS(4,18,6,0);
  ...
  interfaceLcd_Clear_Swipe(3);  
}
//��������������������������������������������������������������������������������������������������

//void interfaceLcd_Draw_Text_Line(unsigned char x, unsigned char y, unsigned char *string, unsigned char font);
