#ifndef PILOTEANALOGUE0_H
#define PILOTEANALOGUE0_H

//MODULE: piloteAnalogue0
...
//#define PILOTEANALOGUE0_BROCHE A4
...
//Fonctions publiques:
unsigned int piloteAnalogue0_lit(void);
void piloteAnalogue0_initialise(void);
