...
#define PILOTEMOTEURBENNEHAUT_BROCHE 4  // A définir
...
#define INTERFACESUIVEUR_ADRESSE 0x3A  //Vérifier par le programme
...
//Define pour le processu Conduite
#define PROCESSUSCONDUITE_VITESSESTANDARD 250
#define PROCESSUSCONDUITE_REQUETEACTIVE 1
...
// phase 4 et 5 sont réservé au service Communication
